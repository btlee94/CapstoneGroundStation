...
ap.add_argument("-w", "--waypoints", help="List of desired waypoint coordinates as longitude and latitude")
ap.add_argument("-a", "--altitude", help="Desired relative altitude in meters")
ap.add_argument("-r","--radius", help="Desired parameter radius for all waypoints")
...
if not args.get("waypoints", False):
    desiredWaypoints = ""
else:
...
#target = sys.argv[1] if len(sys.argv) >= 2 else '127.0.0.1:14552'
...
#Arm and take of to altitude
alt = float(desiredAlt)
arm_and_takeoff(alt)
